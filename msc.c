...
int sc_regSet (int reg, int value) { // sets the flag register value, #define-s are used for register numbers, if wrong register number - error

}

int sc_regGet (int reg, int *value) { // gets the flag value, if wrong register - error
